...
To run this code in its current state, it is quite simple. The main.rb file will iterate through and pull all the data we need and store it locally. Then, simply push that to github. That can be done via

```bash
ruby scrapers/main.rb
```
